  ...
  return (
    <div className="w-11/12 h-full mx-auto flex flex-col p-3 xl:px-10 mb-[5%] gap-10">
      ...
      <div className="flex relative mt-5 mb-5 xl:-mb-12">
        {/* Big text with name */}
        <div className="h-[250px] md:w-[50%] md:left-[20%] xl:w-[48%] xl:h-[400px] bg-slate-200 p-5 absolute top-[45%] left-[24%] xl:left-[18%] z-1 opacity-80 rounded-md shadow-2xl flex flex-col justify-around">
