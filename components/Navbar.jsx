...
const Navbar = () => {
  ...
  return (
    <div className="ml-5 w-full px-5 sticky top-0 bg-white z-20 flex h-24 mx-auto">
      <div className="px-5 py-2 xl:px-10 xl:py-5 border-gray-950 flex w-[100%] items-center justify-between">
